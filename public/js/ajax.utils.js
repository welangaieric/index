...
// ===============================================
        ...
        $.ajax({
            ...
            success: function(empData){
                ...
                $('#search_emp').on('click',function(){
                    ...
                    console.log(phone)
                    getResource(`http://127.0.0.1:3000/api/employees/search/${phone}`, function (error, mdata) {
                        if (error) {
                            // Handle error
                            temp = `
                ...
                $('.deleteEmp').each(function () {
                    $(this).on('click', function (e) {
                        ...
                        $.ajax({
                            type:'delete',
                            url: `http://127.0.0.1:3000/api/employees/${id}`,
                            success:function(){
                                let display = $('#empCard')
                                display.html('')
                                getEmployees()
    ...
    frm.submit(function(e){
        ...
        $.ajax({
            ...
            url:'http://127.0.0.1:3000/api/employees/addemployee',
            data:frm.serialize(),
            success:function(response){
        ...
        $.ajax({
            ...
            success:(data)=>{
                ...
                $('#searchPay').on('click',function(){
                    ...
                    console.log(code)
                    getResource(`http://127.0.0.1:3000/api/transactions/${code}`, function (error, e) {
                        if (error) {
                            // Handle error
                            temp = `
    ...
    frmm.submit(function(e){
        ...
        $.ajax({
            ...
            url:'http://127.0.0.1:3000/api/profiles/addprofile',
            data:frmm.serialize(),
            success:function(response){
            ...
            success:(data)=>{
                ...
                $('.deleteclient').each(function () {
                    $(this).on('click', function (e) {
                        ...
                        $.ajax({
                            type:'delete',
                            url: `http://127.0.0.1:3000/api/clients/${id}`,
                            success:function(){
                ...
                $('#searchClient').on('click',function(){
                    ...
                    getResource(`http://127.0.0.1:3000/api/clients/${username}`, function (error, [e]) {
                        if (error) {
                            // Handle error
                            temp = `
...
$('#FixedClients').on('click',()=>{
    ...
    clientForm.submit(function(e){
        ...
        $.ajax({
            ...
            url:'http://127.0.0.1:3000/api/clients/addclient',
            ...
            success:(data)=>{
               ...
               let totalPurchases = amount.reduce((accumulator,currentValue)=>{
                return accumulator+currentValue;
                    ...
                    const dispcurrentDate = new Date();
                    const dispday = dispcurrentDate.getDate();
                    const dispmonth = dispcurrentDate.getMonth() + 1; // Month is zero-based, so add 1
                    const dispyear = dispcurrentDate.getFullYear();

                    // Format the date as "dd/mm/yyyy"
                    const formatedDate = `${dispday}/${dispmonth}/${dispyear}`;
                        ...
                        <div class="analytics-header">
                            ...
                            <div class="controls">
                                ...
                                <div class="today-date">
                                    <i class="bi bi-calendar-event"></i> <p>Today:${formatedDate}</p>
                                </div>
                            </div>
                        </div>
